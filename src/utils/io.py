"""
Utility functions for working with the file system, terminal etc.
"""
...
def create_run_directory(hparams: dict) -> tuple:
    """
...
def parse_cli_keyword_args(args: list) -> dict:
    """
...
def parse_type(string: str) -> object:
    """
